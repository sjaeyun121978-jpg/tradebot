...
def analyze(symbol: str, candles_by_tf: dict, market_data: dict = None) -> dict:
    """
    단일 분석 엔진.
    market_data: collect_market_data() 결과 (없으면 기술적 분석만)
    """
    ...
    scores = calc_scores(c15, c1h, c4h, c1d, market_data)
