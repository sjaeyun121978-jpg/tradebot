...
def analyze_structure(symbol, candles_by_tf, market_data=None):
    sig = _core_analyze(symbol, candles_by_tf, market_data)
...
def run_structure_analysis(symbol, candles_by_tf, market_data=None):
    return analyze_structure(symbol, candles_by_tf, market_data)

def fact_based_structure_analysis(symbol, candles_by_tf):
    return analyze_structure(symbol, candles_by_tf)

def analyze(symbol, candles_by_tf, market_data=None):
    return analyze_structure(symbol, candles_by_tf, market_data)
